...
exports.BUILT_IN_INTENTS_ALEXA = [
  ...
  //   slots: ['targetCollection.owner.name', 'object.name', 'object.author.name', 'targetCollection.type'],
  // },
  // {
  //   name: 'AMAZON.ChooseAction<object@Book,sourceCollection@ReadingList>',
  //   slots: ['object.type', 'object.select', 'sourceCollection.type'],
  // },
  // {
  //   name: 'AMAZON.ChooseAction<object@Book>',
  //   slots: ['object.type', 'object.name', 'object.select', 'object.author.name'],
  // },
  // {
  ...
  //   slots: ['object.type', 'object.name', 'sourceCollection.owner.name', 'sourceCollection.type'],
  // },
  // {
  ...
  //   slots: ['object.owner.name', 'object.type', 'object.name', 'object.select', 'object.author.name'],
  // },
  // {
  ...
  //   slots: ['object.datePublished.type', 'object.type'],
  // },
  // {
  //   name: 'AMAZON.SearchAction<object@Book[numberOfSections]>',
  //   slots: ['object.numberOfSections', 'object.type', 'object.hasPart.type', 'object.numberOfSections.type'],
  // },
  // {
  ...
  //   slots: ['object.owner.name', 'object.type', 'object.name'],
  // },
  // {
  //   name: 'AMAZON.SuspendAction<object@Book>',
  //   slots: ['object.owner.name', 'object.type', 'duration.name'],
  // },
  // {
  //   name: 'AMAZON.ReadAction<object@Calendar>',
  //   slots: ['object.owner.name', 'object.type'],
  // },
  // {
  //   name: 'AMAZON.SearchAction<object@Calendar>',
  //   slots: ['object.owner.name', 'object.startTime', 'object.type', 'object.event.type', 'object.event.startDate'],
  // },
  // {
  //   name: 'AMAZON.ChooseAction<object@ScreeningEvent[location]>',
  //   slots: ['object.location.name'],
  // },
  // {
  ...
  //   slots: ['object.type', 'object.sort', 'object.name', 'object.genre', 'object.byArtist.name'],
  // },
  // {
  ...
  //   slots: ['sourceCollection.type', 'object.type', 'object.genre', 'object.byArtist.name', 'sourceCollection.name'],
  // },
  // {
  //   name: 'AMAZON.DeleteAction<object@MusicPlaylist,sourceCollection@Catalog>',
  //   slots: ['sourceCollection.owner.name', 'object.type', 'object.select', 'sourceCollection.type'],
  // },
  // {
  ...
  //   slots: ['object.userPreference.type', 'object.type'],
  // },
  // {
  ...
  //   slots: ['object.owner.name', 'object.type', 'object.name', 'mode.name'],
  // },
  // {
  ...
  //   slots: ['sourceCollection', 'sourceCollection.type', 'object.name', 'object.select'],
  // },
  // {
  //   name: 'AMAZON.ChooseAction<object@VideoCreativeWork>',
  //   slots: ['object.character.name', 'object.type', 'object.select', 'object.genre', 'object.byArtist.name'],
  // },
  // {
  ...
  //   slots: ['object.partOfSeries.name', 'object.type', 'object.name', 'object.select'],
  // },
  // {
  //   name: 'AMAZON.RateAction<object@VideoCreativeWork>',
  //   slots: ['rating.ratingValueUnit', 'object.select', 'object.type', 'object.name', 'rating.ratingValue', 'rating.bestRating'],
  // },
  // {
  ...
  //   slots: ['object.type', 'object.name', 'sourceCollection.owner.name', 'sourceCollection.name'],
  // },
  // {
  ...
  //   slots: ['object.type', 'object.name', 'object.actor.type'],
  // },
  // {
  //   name: 'AMAZON.SearchAction<object@VideoCreativeWork[audience]>',
  //   slots: ['object.type', 'object.audience.type', 'object.name'],
  // },
  // {
  ...
  //   slots: ['object.name', 'object.description.type'],
  // },
  // {
  ...
  //   slots: ['object.genre.type', 'object.type'],
  // },
  // {
  ...
  //   slots: ['object.quantity', 'object.type'],
  // },
  // {
  //   name: 'AMAZON.SuspendAction<object@VideoCreativeWork>',
  //   slots: ['object.type', 'duration.name'],
  // },
  // {
  //   name: 'AMAZON.WatchAction<object@VideoCreativeWork>',
  //   slots: ['object.partOfSeries.type', 'object.type', 'object.select'],
  // },
  // {
  ...
  //   slots: ['sourceCollection.type', 'object.name'],
  // },
  // {
  ...
  //   slots: ['object.quantity', 'object.location.name'],
  // },
  // {
  ...
  //   slots: ['object.owner.name', 'object.itemListElement', 'object.name', 'object.sort'],
  // },
  // {
  //   name: 'AMAZON.DeleteAction<object@Thing>',
  //   slots: ['amount.quantity', 'sourceCollection.owner.name', 'sourceCollection.type'],
  // },
  // {
  //   name: 'AMAZON.ExitAction<object@Episode>',
  //   slots: ['object.type', 'object.isPartOfTVSeries.name'],
  // },
  // {
  ...
  //   slots: ['object.partOfTVSeries.name', 'object.type', 'object.select'],
  // },
  // {
  ...
  //   slots: ['object.type', 'object.select', 'object.sectionNumber'],
  // },
  // {
  //   name: 'AMAZON.ResumeAction<object@CreativeWorkSection>',
  //   slots: ['object.type', 'object.sectionNumber'],
  // },
  // {
  ...
  //   slots: ['object.datePublished', 'object.type'],
  // },
  // {
  ...
  //   slots: ['object.owner.name', 'object.startTime', 'object.eventStatus.type', 'object.select', 'object.type'],
  // },
  // {
  //   name: 'AMAZON.SearchAction<object@Event[location]>',
  //   slots: ['object.owner.name', 'object.type', 'object.name', 'object.startDate'],
  // },
  // {
...
exports.DEFAULT_INTENTS = {
  ...
  hi: {
    defaults: [
      {
        name: 'AMAZON.CancelIntent',
        samples: ['रद्द करना', 'मंसूख करना', 'निरस्त करना'],
      },
      {
        name: 'AMAZON.HelpIntent',
        samples: ['मदद', 'सहायता', 'सहाय'],
      },
      {
        name: 'AMAZON.StopIntent',
        samples: ['रुकें', 'रोकना', 'विराम'],
      },
      {
        name: 'AMAZON.YesIntent',
        samples: ['हाँ', 'य', 'ओके', 'ओके', 'यूप', 'य', 'ज़रूर'],
        keep: ['हाँ'],
      },
      {
        name: 'AMAZON.NoIntent',
        samples: ['नहीं', 'नोप', 'ने', 'न', 'नो वे', 'नेगेटिव'],
      },
    ],
    built_ins: [
      {
        name: 'AMAZON.RepeatIntent',
        samples: ['फिर से', 'फिर से', 'फिर से कहना'],
      },
    ],
  },
};
